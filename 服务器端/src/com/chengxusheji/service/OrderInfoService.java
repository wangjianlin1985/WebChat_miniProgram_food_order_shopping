...
public class OrderInfoService {
    ...
    /*按照查询条件分页查询订单记录*/
    public ArrayList<OrderInfo> queryOrderInfo(Product productObj,String orderStateObj,String receiveName,String telephone,UserInfo userObj,String orderTime,int currentPage) throws Exception { 
    ...
    /*店长按照查询条件分页查询订单记录*/
    public ArrayList<OrderInfo> queryOrderInfo(String shopUserName,String orderStateObj,String receiveName,String telephone,UserInfo userObj,String orderTime,int currentPage) throws Exception { 
     	String where = "where t_product.printShopObj='" + shopUserName + "'"; 
    	if(!orderStateObj.equals("")) where = where + " and t_orderInfo.orderStateObj like '%" + orderStateObj + "%'";
    	if(!receiveName.equals("")) where = where + " and t_orderInfo.receiveName like '%" + receiveName + "%'";
    	if(!telephone.equals("")) where = where + " and t_orderInfo.telephone like '%" + telephone + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null  && !userObj.getUser_name().equals(""))  where += " and t_orderInfo.userObj='" + userObj.getUser_name() + "'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<OrderInfo> queryOrderInfo(Product productObj,String orderStateObj,String receiveName,String telephone,UserInfo userObj,String orderTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != productObj && productObj.getProductId()!= null && productObj.getProductId()!= 0)  where += " and t_orderInfo.productObj=" + productObj.getProductId();
    	if(!orderStateObj.equals("")) where = where + " and t_orderInfo.orderStateObj like '%" + orderStateObj + "%'";
    	if(!receiveName.equals("")) where = where + " and t_orderInfo.receiveName like '%" + receiveName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Product productObj,String orderStateObj,String receiveName,String telephone,UserInfo userObj,String orderTime) throws Exception {
     	String where = "where 1=1";
    	if(null != productObj && productObj.getProductId()!= null && productObj.getProductId()!= 0)  where += " and t_orderInfo.productObj=" + productObj.getProductId();
    	if(!orderStateObj.equals("")) where = where + " and t_orderInfo.orderStateObj like '%" + orderStateObj + "%'";
    	if(!receiveName.equals("")) where = where + " and t_orderInfo.receiveName like '%" + receiveName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String shopUserName,String orderStateObj,String receiveName,String telephone,UserInfo userObj,String orderTime) throws Exception {
     	String where = "where t_product.printShopObj='" + shopUserName + "'";
    	if(!orderStateObj.equals("")) where = where + " and t_orderInfo.orderStateObj like '%" + orderStateObj + "%'";
    	if(!receiveName.equals("")) where = where + " and t_orderInfo.receiveName like '%" + receiveName + "%'";
    	if(!telephone.equals("")) where = where + " and t_orderInfo.telephone like '%" + telephone + "%'";
