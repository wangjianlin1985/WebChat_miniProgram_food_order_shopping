...
<div id="product_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="productQueryForm" method="post">
			菜品类别：<input class="textbox" type="text" id="productClassObj_classId_query" name="productClassObj.classId" style="width: auto"/>
			菜品名称：<input type="text" class="textbox" id="productName" name="productName" style="width:110px" />
			餐饮店：<input class="textbox" type="text" id="printShopObj_shopUserName_query" name="printShopObj.shopUserName" style="width: auto"/>
